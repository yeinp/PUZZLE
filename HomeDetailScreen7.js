...
export default class HomeDetailScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      images: [
        require('./assets/home/나이키모자1.jpg'),
        require('./assets/home/나이키모자2.jpg'),
      ]
    };
  }
    ...
    <View>
      ...
      <View style={{marginLeft:20,marginTop:25,}}>
        <Text style={{fontSize:25,fontWeight:'700'}}>나이키 모자 필요하신분 가져가세요</Text>
        <Text style={{fontSize:17,marginTop:7,color:'grey',fontWeight:'500'}}>여기서 1km · 1분 전</Text>
      </View>


      <View style={{marginLeft:20,marginTop:35,}}>
        <Text style={styles.DetailText}>여성용 나이키 모자입니다</Text>
        <Text style={styles.DetailText}>몇번 쓰다가 잘 안쓰는거같아 올려요~~</Text>
        <Text style={styles.DetailText}>한 3만원 정도에 구입했던거같습니다</Text>
      </View>
      ...
      <View>
        ...
        <View style={{flexDirection:'row',marginTop:20,}}>
          ...
          <TouchableOpacity activeOpacity={0.5} onPress={() => navigate('HomeDetailScreen9')}>
