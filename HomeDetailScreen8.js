...
export default class HomeDetailScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      images: [
        require('./assets/home/미니무선청소기.jpg'),
      ]
    };
  }
    ...
    <View>
      ...
      <View style={{marginLeft:20,marginTop:25,}}>
        <Text style={{fontSize:25,fontWeight:'700'}}>무선청소기 가져가세요~!</Text>
        <Text style={{fontSize:17,marginTop:7,color:'grey',fontWeight:'500'}}>여기서 1km · 1분 전</Text>
      </View>


      <View style={{marginLeft:20,marginTop:35,}}>
        <Text style={styles.DetailText}>무선청소기입니다</Text>
        <Text style={styles.DetailText}>자취할때 썼는데 본가로 가게돼서 안쓸거같아 내놓습니다</Text>
        <Text style={styles.DetailText}>자취생한테 완전 꿀템이에요 가져가세용</Text>
      </View>
